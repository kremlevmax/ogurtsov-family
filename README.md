...
**Статус:** Этапы 0–6 реализованы и развёрнуты в проде —
**https://ogurtsov-family.vercel.app**. Работает вживую: дерево,
поиск, боковая панель, страницы людей, вход двух редакторов, CRUD людей
и связей, загрузка фото/файлов в Cloudflare R2, sitemap/robots,
локальный бэкап и GEDCOM-экспорт. Шаги развёртывания — в
...
Все этапы из `CLAUDE.md`, раздел 22, реализованы и развёрнуты. Дальше —
по мере необходимости: кастомный домен (пока используется бесплатный
`ogurtsov-family.vercel.app`, см. `docs/DEPLOYMENT.md`, раздел 5),
визуальная полировка, если появятся новые референсы.
